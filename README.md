# Awesome air quality with stars
...
* C#
  * [openair](https://github.com/hzexe/openair) ⚠️ Archived - National air quality data acquisition library (Chinese)

* Java
  * [NAPSDataAnalysis](https://github.com/dbeaudoinfortin/NAPSDataAnalysis) ⭐ 10 | 🐛 23 | 🌐 Java | 📅 2025-04-09 - Canadian National Air Pollution Surveillance Program (NAPS) data downloader, importer, extractor, analysis, and visualization toolbox.

* NodeJS
  * [openaq](https://github.com/nickolasclarke/openaq) ⭐ 18 | 🐛 1 | 🌐 JavaScript | 📅 2017-03-14 - *A JS client for the OpenAQ API*
...
* Python
  ...
  * [atmospy](https://github.com/quant-aq/atmospy) ⭐ 15 | 🐛 10 | 🌐 Python | 📅 2026-08-17  - *visualization and analysis tools for air quality data in python*
  ...
  * [The QuantAQ CLI](https://github.com/quant-aq/cli) ⭐ 8 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - *QuantAQ command line interface*
  ...
  * [airinsights](https://github.com/edf-org/airinsights) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Analysis suite to translate local air quality data into actionable insights.
...
* R
  ...
  * [RAQSAPI](https://github.com/USEPA/RAQSAPI) ⭐ 26 | 🐛 4 | 🌐 R | 📅 2026-07-23 - A R extension to Retrieve EPA Air Quality System Data via the AQS Data Mart API.
  ...
  * [beethoven](https://github.com/NIEHS/beethoven) ⭐ 8 | 🐛 11 | 🌐 R | 📅 2026-06-17 - BEETHOVEN is: Building an Extensible, rEproducible, Test-driven, Harmonized, Open-source, Versioned, ENsemble model for air quality.
...
* Rust
  * [openaq-client](https://github.com/igncp/openaq-client) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2017-05-21 - Unofficial Open Air Quality API Client written in Rust [crate](https://crates.io/crates/openaq-client)

## Hardware drivers / software

* C
  * [Embedded SGP Drivers for Sensirion Gas Sensors](https://github.com/Sensirion/embedded-sgp) ⚠️ Archived
  * [Embedded i2c Driver for Sensirion Particulate Matter Sensors](https://github.com/Sensirion/embedded-sps) ⚠️ Archived
  * [LibreCO2](https://github.com/danielbernalb/LibreCO2) ⭐ 51 | 🐛 0 | 🌐 C++ | 📅 2024-02-16
  * [Embedded SCD Drivers for Sensirion CO2 Sensors](https://github.com/Sensirion/embedded-scd) ⚠️ Archived

* C++
  * [PMS](https://github.com/fu-hsi/PMS) ⭐ 155 | 🐛 8 | 🌐 C++ | 📅 2022-03-13 - *Arduino library for Plantower PMS x003 family sensors.*
  * [Arduino library for Sensirion SCD4x sensors](https://github.com/Sensirion/arduino-i2c-scd4x) ⭐ 81 | 🐛 2 | 🌐 C++ | 📅 2026-07-16
...
* Python
  * [bme680-python](https://github.com/pimoroni/bme680-python) ⭐ 288 | 🐛 9 | 🌐 Python | 📅 2024-05-10 - *Python library for the BME680 gas, temperature, humidity and pressure sensor.*
  * [pyaqsapi](https://github.com/USEPA/pyaqsapi) ⭐ 29 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - A python 3 package to retrieve ambient air monitoring data from the United States Environmental Protection Agency’s (US EPA) Air Quality System (AQS) Data Mart API v2 interface
...
* Rust
  * [Rust library with common functionality for I2C sensors](https://github.com/Sensirion/sensirion-i2c-rs) ⭐ 12 | 🐛 0 | 🌐 Rust | 📅 2024-07-17
