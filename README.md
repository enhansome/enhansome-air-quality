...
* Python
  ...
  * [atmospy](https://github.com/quant-aq/atmospy) ⭐ 16 | 🐛 9 | 🌐 Python | 📅 2026-09-22  - *visualization and analysis tools for air quality data in python*
  ...
  * [airinsights](https://github.com/edf-org/airinsights) ⭐ 1 | 🐛 1 | 🌐 Python | 📅 2026-09-17 - Analysis suite to translate local air quality data into actionable insights.
...
* R
  ...
  * [openair](https://github.com/davidcarslaw/openair) ⭐ 364 | 🐛 31 | 🌐 R | 📅 2026-09-24 - *Tools to analyse, interpret and understand air pollution data. Data are typically hourly time series and both monitoring data and dispersion model output can be analysed. Many functions can also be applied to other data, including meteorological and traffic data.* [CRAN](https://cran.r-project.org/web/packages/openair/index.html)
  ...
  * [AMET](https://github.com/USEPA/AMET) ⭐ 26 | 🐛 3 | 🌐 R | 📅 2026-09-23 - Code base for the U.S. EPA’s Atmospheric Model Evaluation Tool (AMET).
  * [RAQSAPI](https://github.com/USEPA/RAQSAPI) ⭐ 26 | 🐛 4 | 🌐 R | 📅 2026-09-24 - A R extension to Retrieve EPA Air Quality System Data via the AQS Data Mart API.
...
* Python
  ...
  * [pyaqsapi](https://github.com/USEPA/pyaqsapi) ⭐ 29 | 🐛 3 | 🌐 Python | 📅 2026-09-22 - A python 3 package to retrieve ambient air monitoring data from the United States Environmental Protection Agency’s (US EPA) Air Quality System (AQS) Data Mart API v2 interface
